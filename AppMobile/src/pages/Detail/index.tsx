...
const Detail = () => {
    ...
    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${data.ponto.numero}&text= Tenho interesse na coleta de resíduos!`);
    }

    function handleComposeMail(){
        MailComposer.composeAsync({
            subject: 'Interesse na coleta de resíduos',
            recipients: [data.ponto.email],
        });
    }
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Text style={styles.pointItems}>
                    {data.itens.map(item => item.nome).join(', ')}
                </Text>

                <View style={styles.address}>
                    <Text style={styles.addressTitle}>Endereço</Text>
                    <Text style={styles.addressContent}>{data.ponto.cidade}, {data.ponto.uf}</Text>
                </View>
            </View>
